#open it in editor then rename and  save it "idmactive.cmd" And save as type "All" and save .
#run as Administrator and select as you want.  done forget save as a ".cmd" file unless not work.  Yash bro
...
::  Thanks to  for the powershell method and solving special characters issue in file path name.
...
cls
title  IAS 0.7  ^(Fork of @Yash's Tool^)
mode 65, 25
...
If not defined name set name=Yash Bro
...
____________________________________________________________________________________________________
   ...
   @       - Original researcher of this IDM trial reset and activation logic,
                         ...
                         nsandComment&comment=1632062
                         
   @t (Me) - Ported the above Autoit tool to batch script
